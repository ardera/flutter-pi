...
#define FLUTTER_POINTER_EVENT(                                                                                                        \
    ...
    (FlutterPointerEvent) {                                                                                                           \
        .struct_size = sizeof(FlutterPointerEvent), .phase = (_phase), .timestamp = (_timestamp), .x = (_x), .y = (_y),               \
        .device = (_device), .signal_kind = (_signal_kind), .scroll_delta_x = (_scroll_delta_x), .scroll_delta_y = (_scroll_delta_y), \
        .device_kind = (_device_kind), .buttons = (_buttons), .pan_x = (_pan_x), .pan_y = (_pan_y), .scale = (_scale),                \
        .rotation = (_rotation)                                                                                                       \
    }
