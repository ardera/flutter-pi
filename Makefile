CC = cc
LD = cc
REAL_CFLAGS = -I./include $(shell pkg-config --cflags gbm libdrm glesv2 egl) -DBUILD_ELM327_PLUGIN -DBUILD_GPIO_PLUGIN -DBUILD_SPI_PLUGIN -DBUILD_TEST_PLUGIN -ggdb $(CFLAGS)
