...
#define UUID(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15) \
    ((uuid_t){ .bytes = { _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15 } })
#define CONST_UUID(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15) \
    ((const uuid_t){ .bytes = { _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15 } })
...
#define QUAD(_top_left, _top_right, _bottom_left, _bottom_right) \
    ((struct quad){ .top_left = _top_left, .top_right = _top_right, .bottom_left = _bottom_left, .bottom_right = _bottom_right })
...
#define AA_RECT_FROM_COORDS(offset_x, offset_y, width, height) \
    ((struct aa_rect){ .offset = VEC2F(offset_x, offset_y), .size = VEC2F(width, height) })
...
ATTR_CONST static inline struct quad get_quad(const struct aa_rect rect) {
    return (struct quad){ .top_left = rect.offset,
...
#define FLUTTER_TRANSFORM_AS_MAT3F(_t) \
    ((struct mat3f){ (_t).scaleX, (_t).skewX, (_t).transX, (_t).skewY, (_t).scaleY, (_t).transY, (_t).pers0, (_t).pers1, (_t).pers2 })
#define MAT3F_AS_FLUTTER_TRANSFORM(_t) \
    ((FlutterTransformation            \
    ){ (_t).scaleX, (_t).skewX, (_t).transX, (_t).skewY, (_t).scaleY, (_t).transY, (_t).pers0, (_t).pers1, (_t).pers2 })

#define MAT3F_TRANSLATION(translate_x, translate_y)                                                                                         \
    ((struct mat3f                                                                                                                          \
    ){ .scaleX = 1, .skewX = 0, .transX = translate_x, .skewY = 0, .scaleY = 1, .transY = translate_y, .pers0 = 0, .pers1 = 0, .pers2 = 1 } \
    )
...
#define MAT3F_ROTY(deg)                                              \
    ((struct mat3f){ .scaleX = cos(((double) (deg)) / 180.0 * M_PI), \
                     .skewX = 0,                                     \
...
ATTR_CONST static inline struct mat3f multiply_mat3f(const struct mat3f a, const struct mat3f b) {
    return (struct mat3f){ .scaleX = a.scaleX * b.scaleX + a.skewX * b.skewY + a.transX * b.pers0,
...
ATTR_CONST static inline struct mat3f add_mat3f(const struct mat3f a, const struct mat3f b) {
    return (struct mat3f){ .scaleX = a.scaleX + b.scaleX,
